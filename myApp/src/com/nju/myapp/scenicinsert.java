    	  ...
    	  public void onClick(View v) {
    		  ...
    		  new Thread(new Runnable() {
                  ...
                  public void run() {
            		  ...
            		  */
           	       	  url= HTTPUtil.url_constant + url_constant+"scenicname="+scenicName+"&scenicinfo="+scenicInfo+"&scenicscore="+scenicScore;
           	          Log.d("远程URL", url);
...
//	       HttpGet request=new HttpGet(url);
	       ...
	       //创建提示框提醒是否登录成功
	       AlertDialog.Builder builder=new Builder(scenicinsert.this);
	       builder.setTitle("提示")
	       .setMessage(result)
